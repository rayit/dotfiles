# node
# Autogenerated from man page /usr/share/man/man1/node.1.bz2
...
complete -c node -l experimental-abortcontroller -d 'Enable experimental AbortController and AbortSignal support'
